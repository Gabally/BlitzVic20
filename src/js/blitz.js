...
class Player {
    constructor(x = 0, y = 0, w = 0, h = 0, groundline = 0) {
        ...
        this.width = w;
        this.height = h;
        this.image = craft_img("assets/imgs/plane1.png", 64, 18);
        this.alive = true;
        this.tolerance = 1;
        this.speed = 15;
        this.sources = [
            craft_img("assets/imgs/plane1.png", 64, 18),
            craft_img("assets/imgs/plane2.png", 64, 18)
        ];
        this.currentImage = 0;
        this.deltaAnime = 200;
        this.lastChange = 0;
        this.deathSound = new Audio("assets/sounds/explosion.mp3");
    }
...
class Game {
    constructor() {
        ...
        this.points = 0;
        this.died = false;
        this.planeSound = new Audio("assets/sounds/plane.mp3");
        this.planeSound.loop = true;
        this.windSound = new Audio("assets/sounds/cleared.mp3");
        this.scoreImg = craft_img("assets/imgs/score.png", 148, 14);
        this.bestImg = craft_img("assets/imgs/best.png", 116, 14);
        this.tped = false;
    }
...
class Bomb extends Sprite {
    constructor(x, y) {
        super("assets/imgs/bomb.png", x, y, 24, 24, 0, 40);
...
class Building {
    constructor(x) {
        let aviableBuildings = [
            { src: "assets/imgs/building1.png", w: 56, h: 96, p: 2 },
            { src: "assets/imgs/building2.png", w: 56, h: 352, p: 7 },
            { src: "assets/imgs/building3.png", w: 56, h: 192, p: 3 },
            { src: "assets/imgs/building4.png", w: 56, h: 224, p: 6 },
            { src: "assets/imgs/building5.png", w: 56, h: 128, p: 3 },
            { src: "assets/imgs/building6.png", w: 56, h: 256, p: 5 },
        ]
